...
export function createAdvertisement(typeOfVehicle, title, vehicle, date, images, description, town, nameForContacts, eMail , gsm){
	return new Advertisement(typeOfVehicle, title, vehicle, date, images, description, town, nameForContacts, eMail , gsm);
}
