...
export function createAdController(context) {
	loadTemplate('createAd')
		.then(template => {
			...
			attachAdditionalFieldsForVehiclesToForm(currentVehicleTypeSelectedString);
...
function attachAdditionalFieldsForVehiclesToForm(currentVehicleTypeSelectedString) {
...
function createAdFromFormFieldsValues(valuesFromForm, currentVehicleTypeSelectedString) {
	...
	if (currentVehicleTypeSelectedString === 'cars') {
		...
		currentVehicle = factory.createCar(valuesFromForm.model, valuesFromForm.year, valuesFromForm.kilometers, valuesFromForm.price, valuesFromForm.fuel, valuesFromForm.transmission, valuesFromForm.horsepower, valuesFromForm.type, valuesFromForm.numberOfDoors, valuesFromForm.numberOfSeats);
	}
	else if (currentVehicleTypeSelectedString === 'motorcycles') {
		// manufacturer, model, year, kilometers, price, fuel, transmission, horsepower, type
		currentVehicle = factory.createMotorcycle(valuesFromForm.model, valuesFromForm.year, valuesFromForm.kilometers, valuesFromForm.price, valuesFromForm.fuel, valuesFromForm.transmission, valuesFromForm.horsepower, valuesFromForm.type);
	}
	else if (currentVehicleTypeSelectedString === 'trucks') {
		// manufacturer, model, year, kilometers, price, fuel, transmission, horsepower, type, maxLoadCapacity, numberOfWheels
		currentVehicle = factory.createTruck(valuesFromForm.model, valuesFromForm.year, valuesFromForm.kilometers, valuesFromForm.price, valuesFromForm.fuel, valuesFromForm.transmission, valuesFromForm.horsepower, valuesFromForm.type, valuesFromForm.maxLoadCapacity, valuesFromForm.numberOfWheels);
	}
	else if (currentVehicleTypeSelectedString === 'campers') {
		// manufacturer, model, year, kilometers, price, fuel, transmission, horsepower, type, numberOfSleepingPlaces
		currentVehicle = factory.createCamper(valuesFromForm.model, valuesFromForm.year, valuesFromForm.kilometers, valuesFromForm.price, valuesFromForm.fuel, valuesFromForm.transmission, valuesFromForm.horsepower, valuesFromForm.type, valuesFromForm.numberOfSleepingPlaces);
	}

	let nowDate = moment().format('MMM Do YYYY, hh:mm');
	// title, vehicle, date, images, description, town, nameForContacts, eMail , gsm
	let ad = factory.createAdvertisement(valuesFromForm.title, currentVehicle, nowDate, valuesFromForm.images, valuesFromForm.description, valuesFromForm.town, valuesFromForm.nameForContacts, valuesFromForm.eMail, valuesFromForm.gsm);
